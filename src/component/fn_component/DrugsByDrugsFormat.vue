  ...
  <div id="charge">
    ...
    <el-row :gutter="20" :span="20" style="margin-left: 30px">
      ...
      <el-col :span="6" style="margin-top: 35px">
        <!-- 第一行 -->
        <span>"101"表示为中药  "102"表示为西药  "103"表示为中成药</span>
        <el-row :gutter="40" :span="20">
          <el-col :span="8">
            <el-input v-model="drugsType" placeholder="药品规格"></el-input>
          </el-col>
          <el-col :span="4">
            <el-button type="primary" @click="getAllDrugsByDrugsFormat">查询</el-button>
          </el-col>
...
getAllDrugsByDrugsFormat(){
 this.$fetch("/sf/listDrugsByDrugsName",{drugsType: this.drugsType}).then(res =>{
          this.cc=res.data
             this.$message("查询成功");
        })
},
