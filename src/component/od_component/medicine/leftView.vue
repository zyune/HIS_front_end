<template>
  ...
  <div style="margin-top: 10px;margin-bottom: 20px;padding-left: 20px;padding-right: 20px">
    <h1 style="text-align: center;padding-bottom: 6px;">西药申请列表单</h1>
    <el-row>
      <el-col :span="6"><div>西药申请列表单</div></el-col>
    ...
    <div style="border: 1px black solid;padding-top: 20px;padding-right: 20px;">
      ...
      <el-col :span="16">
        <el-row>
          <el-col :span="6"><div>西药项目列表</div></el-col>
    ...
    <el-dialog title="西药项目结果情况" :visible.sync="dialogResultVisible" >
      <el-row>
    ...
    <el-dialog title="新增西药项目" :visible.sync="dialogTableVisible" >
      <el-row>
        <el-col :span="1">  &nbsp; </el-col>
          <el-col :span="24"><div>
            <el-row>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      sureUseHerbalTemplateAppliction() {
        if(this.$store.getters.getInspectionPatient.isSeenDocator !=2 ){
          ...
          this.dialoguseHerbalTemplate.herbalType = "1";//西药申请
      ...
      searchItemByName() {
        this.loading = true;
        var _this = this;
        this.$axios.get("/od/getMedicineDrugsByName", {
          params: {
      ...
      loadingPatientHerbalInfo() {
        ...
        if (this.$store.getters.getInspectionPatient.medicalRecord == null) {
          ...
          this.$axios.get("/od/getMedicineApplicationByblh", {
            params: {
    ...
    created() {
      ...
      //当用户进行西药申请的时候，会触发这个逻辑，使得逻辑能够新增加一条记录
