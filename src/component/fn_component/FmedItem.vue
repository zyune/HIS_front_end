    ...
    <el-row :gutter="20" :span="20" style="margin-left: 30px">
      ...
      <el-col :span="6" style="margin-top: 35px">
        ...
        <el-row :gutter="40" :span="20">
          <el-col :span="8">
            <el-input v-model="itemname" placeholder="请输入名称"></el-input>
          </el-col>
          <el-col :span="4">
            <el-button type="primary" @click="getAllFmedItemByItemname">查询</el-button>
          </el-col>
...
export default {
  ...
  methods: {
    ...
    getAllFmedItemByItemname(){
         this.$fetch("sf/listFmedItemByItemname",{itemname: this.itemname}).then(res =>{
          this.cc=res.data
             this.$message("查询成功");
        })
    },
